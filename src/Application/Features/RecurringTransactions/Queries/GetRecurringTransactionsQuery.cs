...
-    public async Task<Result<List<RecurringTransactionDto>>> Handle(GetRecurringTransactionsQuery request, CancellationToken cancellationToken)
...
-            .ThenByDescending(rt => rt.NextProcessDate)
